...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'software_renderer.data';
      var REMOTE_PACKAGE_BASE = 'software_renderer.data';
  ...
  Module['FS_createPath']("/", "resources", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_software_renderer.data');

      };
      Module['addRunDependency']('datafile_software_renderer.data');
   ...
   loadPackage({"files": [{"filename": "/resources/arrow.obj", "start": 0, "end": 2079, "audio": 0}, {"filename": "/resources/test.png", "start": 2079, "end": 233297, "audio": 0}, {"filename": "/resources/monkey.obj", "start": 233297, "end": 319470, "audio": 0}], "remote_package_size": 319470, "package_uuid": "f83e4622-0458-4cf9-9fb2-501a96641d4a"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'software_renderer.wasm';
...
var ASM_CONSTS = {
  ...
  var Asyncify = {State:{Normal:0,Unwinding:1,Rewinding:2,Disabled:3},state:0,StackSize:4096,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,afterUnwind:null,asyncFinalizers:[],sleepCallbacks:[],getCallStackId:function(funcName) {
        ...
        var ASYNCIFY_IMPORTS = ["env.open_tab","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env.dlopen"].map(function(x) {
          return x.split('.')[1];
        });
